...
volatile ql_model_feature_ctx_s ql_model_feature_ctx = {
    ...
    .gnss_enabled_gpio_type = 1,            //模块内部的GPIO10-GPIO12给GNSS使用
#elif defined CONFIG_QL_PROJECT_DEF_EG912U
    .gnss_enabled_gpio_type = 2,            //模块内部的GPIO9、GPIO11、GPIO12给GNSS使用
#else
    .gnss_enabled_gpio_type = 1,
#endif
#else
    .gnss_enabled_gpio_type = 0,
#endif
